...
const toggleMenu = () => {
  ...
  return (
    ...
    {/* // large screen */}
    <section className='hidden md:flex w-full h-24 justify-between items-center border-b border-white/10 px-10'>
        ...
        {/* Wrapped navigation in a proper semantic ul container */}
        <ul className="flex items-center space-x-9 list-none">
            ...
            <Link to="/login" className="bg-[#1F2937] hover:bg-[#2A374A] text-[#E8EAED] font-semibold py-2 px-4 rounded transition-colors text-sm">Log in</Link>
    ...
    {/* // small screens */}
    <section className="md:hidden flex w-full h-20 justify-between items-center px-4 border-b border-white/5">
  ...
  {isOpen ? (
    ...
    {/* Mobile Drawer Panel with corrected structural flex layout stacking */}
